...
% filenames
bemobil_config.merged_filename = '_EEG.set';
...
bemobil_config.bids_task_label = 'fastReach'; 
...
bemobil_config.bids_eeg_keyword = 'BrainVision RDA';
bemobil_config.other_data_types = {'motion', 'physio'};

% keywords in stream names in .xdf file that contain motion data
bemobil_config.rigidbody_streams = {'Rigid_handR'};
bemobil_config.physio_streams = {'OpenSignals'};
...
bemobil_config.bids_rb_in_sessions = logical([1]);
...
bemobil_config.rigidbody_names          =  {'Hand'};
...
bemobil_config.bids_motion_position_units      = 'm';                       
bemobil_config.bids_motion_orientation_units   = 'rad';                     % if multisession, cell array of size 1 x session number
...
%% Preprocessing Physio
bemobil_config.ref_channel_physio  = []; 
