...
fastReach_bemobil_bids_metadata; 
...
for subject = subjects
    ...
    EEG = pop_loadset('filename',[ bemobil_config.filename_prefix num2str(subject) '__MOTION.set'],'filepath',input_filepath);
