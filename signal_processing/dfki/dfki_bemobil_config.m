...
if strcmp(current_sys,'win')
    ...
    path = '/Users/lukasgehrke/Documents/publications/dfki';
end
...
% filenames
bemobil_config.merged_filename = '1_EEG.set';
...
bemobil_config.merged_physio_filename = '1_PHYSIO.set';
bemobil_config.merged_motion_filename = '1_MOTION.set';
