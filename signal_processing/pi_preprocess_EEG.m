...
output_filepath = [bemobil_config.study_folder bemobil_config.EEG_preprocessing_data_folder bemobil_config.filename_prefix num2str(subject)];
EEG_preprocessed = pop_loadset('filename', [ bemobil_config.filename_prefix num2str(subject)...
	'_' bemobil_config.preprocessed_filename], 'filepath', output_filepath);
